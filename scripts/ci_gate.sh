...
syntax_check() {
  ...
  python -m py_compile mcp_server.py src/agent/tools/holding_tools.py src/agent/tools/stock_analysis_tool.py
  python -m py_compile src/repositories/agent_holding_repo.py src/services/agent_holding_service.py
